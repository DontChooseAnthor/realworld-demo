...
func (ac *ArticleCreate) SetAuthor(u uint32) *ArticleCreate {
...
func (ac *ArticleCreate) SetLastModify(t time.Time) *ArticleCreate {
	ac.mutation.SetLastModify(t)
	return ac
}

// SetOwnerID sets the "owner" edge to the User entity by ID.
func (ac *ArticleCreate) SetOwnerID(id uint32) *ArticleCreate {
...
func (ac *ArticleCreate) check() error {
	...
	if _, ok := ac.mutation.LastModify(); !ok {
		return &ValidationError{Name: "last_modify", err: errors.New(`ent: missing required field "Article.last_modify"`)}
	}
...
func (ac *ArticleCreate) createSpec() (*Article, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.LastModify(); ok {
